...
import { use_StudentWordMastery, AralinWordInfo, WordPeriodSlot } from '../../../Hooks/use_StudentWordMastery';
    ...
    <View>
      ...
      <View style={S.chipRow}>
        ...
        <View style={[S.chip, { backgroundColor: '#f59e0b12' }]}>
          <Text style={[S.chipNum, { color: '#d97706' }]}>{stats.inProgress}</Text>
      ...
      {/* ── LAYER 3: Bar chart — words mastered per slot ── */}
      <View style={S.chartSection}>
        <View style={S.chartHeader}>
          <Text style={S.chartTitle}>Mga Salitang Natutuhan</Text>
          {hasAnyActivity && (
            <View style={[S.badge, { backgroundColor: GREEN_DIM }]}>
              <Text style={[S.badgeText, { color: '#16a34a' }]}>
                {periodSlots.reduce((s, sl) => s + sl.wordCount, 0)} salita
              </Text>
            </View>
          )}
        </View>
        ...
        {hasAnyActivity ? (
          ...
          <View style={S.emptyChart}>
            ...
            <Text style={S.emptyTitle}>Walang bagong salita</Text>
            <Text style={S.emptyBody}>
              Walang salita ang natapos sa panahong ito.
            </Text>
          </View>
        )}
      </View>

      {/* ── LAYER 4: Letter selector ── */}
