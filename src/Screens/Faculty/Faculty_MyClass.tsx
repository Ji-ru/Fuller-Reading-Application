...
filterText: { fontSize: 12, fontWeight: '800', color: F.slate, fontFamily: 'Andika-Regular' },
  filterTextActive: { color: F.white, fontFamily: 'Andika-Bold' },
  ...
  className: { fontSize: 17, fontWeight: '800', color: F.ink, fontFamily: 'Andika-Bold' },
  classYear: { fontSize: 12, color: F.slate, marginTop: 2, fontWeight: '600', fontFamily: 'Andika-Regular' },
  moreBtn: { width: 40, height: 40, justifyContent: 'center', alignItems: 'center' },
  moreText: { color: '#999', fontSize: 18, fontWeight: 'bold', fontFamily: 'Andika-Regular' },
...
menuItem: { flexDirection: 'row', alignItems: 'center', padding: 12, borderRadius: 12 },
   menuItemText: { fontSize: 14, fontWeight: '700', color: F.ink, marginLeft: 12, fontFamily: 'Andika-Regular' },
  ...
  modalHeader: { fontSize: 20, fontWeight: '900', color: F.ink, marginBottom: 20, fontFamily: 'Andika-Bold' },
  modalLabel: { fontSize: 13, fontWeight: '800', color: F.ink, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8, marginTop: 16, fontFamily: 'Andika-Bold' },
  input: { borderBottomWidth: 1.5, borderBottomColor: F.primary + '30', paddingVertical: 10, fontSize: 16, color: F.ink, marginBottom: 12, fontFamily: 'Andika-Regular' },
  errorText: { color: F.red, fontSize: 12, fontWeight: '700', marginTop: -4, fontFamily: 'Andika-Regular' },
  ...
  cancelBtnText: { color: F.slate, fontWeight: '700', fontFamily: 'Andika-Regular' },
  confirmBtn: { backgroundColor: F.primaryDeep, paddingHorizontal: 24, paddingVertical: 10, borderRadius: 10 },
  confirmBtnText: { color: F.white, fontWeight: '800', fontFamily: 'Andika-Bold' },
  ...
  actionTitle: { fontSize: 20, fontWeight: '900', color: F.ink, marginBottom: 12, fontFamily: 'Andika-Bold' },
  actionSub: { fontSize: 15, color: F.slate, textAlign: 'center', lineHeight: 22, marginBottom: 32, fontFamily: 'Andika-Regular' },
