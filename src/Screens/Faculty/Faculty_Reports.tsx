...
const S = StyleSheet.create({
  ...
  dropdownLabel: { fontSize: 10, fontWeight: '700', color: F.slate, textTransform: 'uppercase', letterSpacing: 0.5, fontFamily: 'Andika-Regular' },
  dropdownValue: { fontSize: 15, fontWeight: '800', color: F.ink, marginTop: 2, fontFamily: 'Andika-Bold' },
  ...
  dropdownModalTitle: { fontSize: 18, fontWeight: '900', color: F.ink, fontFamily: 'Andika-Bold' },
  dropdownCloseText: { fontSize: 14, fontWeight: '700', color: F.primary, fontFamily: 'Andika-Bold' },
  ...
  dropdownItemText: { fontSize: 15, fontWeight: '700', color: F.ink, fontFamily: 'Andika-Bold' },
  dropdownItemTextActive: { color: F.primaryDeep, fontWeight: '800', fontFamily: 'Andika-Bold' },
  dropdownItemMeta: { fontSize: 11, color: F.slate, marginTop: 2, fontFamily: 'Andika-Regular' },
  ...
  tabText: { fontSize: 13, fontWeight: '800', color: F.slate, fontFamily: 'Andika-Regular' },
  tabTextActive: { color: F.white, fontFamily: 'Andika-Bold' },

  mainLoading: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: 100 },
  loadingBox: { alignItems: 'center', paddingVertical: 40 },
  loadingText: { marginTop: 12, color: F.slate, fontWeight: '600', fontFamily: 'Andika-Regular' },
  emptyText: { textAlign: 'center', color: F.slate, fontWeight: '600', paddingVertical: 20, fontFamily: 'Andika-Regular' },

  section: { backgroundColor: F.white, borderRadius: Radii.xl, padding: 20, marginBottom: 16, ...Shadows.card },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 16 },
  sectionTitle: { fontSize: 15, fontWeight: '800', color: F.ink, marginLeft: 10, fontFamily: 'Andika-Bold' },

  studentRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#f5f5f5' },
  studentName: { fontSize: 14, fontWeight: '700', color: F.ink, fontFamily: 'Andika-Bold' },
  studentMeta: { fontSize: 11, color: F.slate, marginTop: 2, fontFamily: 'Andika-Regular' },
  scorePill: { backgroundColor: F.primary + '15', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 8, marginRight: 8 },
  scoreText: { fontSize: 13, fontWeight: '800', color: F.primary, fontFamily: 'Andika-Bold' },

  avatarBoxSmall: { width: 36, height: 36, borderRadius: 12, backgroundColor: F.primary + '15', justifyContent: 'center', alignItems: 'center' },
  avatarTextSmall: { fontSize: 16, fontWeight: '900', color: F.primaryDeep, fontFamily: 'Andika-Bold' },
  backToListBtn: { flexDirection: 'row', alignItems: 'center', marginBottom: 16, alignSelf: 'flex-start' },
  backToListText: { fontSize: 14, fontWeight: '800', color: F.primaryDeep, marginLeft: 4, fontFamily: 'Andika-Bold' },
  ...
  mistakeWord: { fontSize: 14, fontWeight: '700', color: F.ink, fontFamily: 'Andika-Bold' },

  aralinList: { marginTop: 8 },
  aralinRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 16 },
  aralinLabel: { fontSize: 13, fontWeight: '700', color: F.ink, marginBottom: 4, fontFamily: 'Andika-Bold' },
  progressBar: { height: 6, backgroundColor: '#f0f3f6', borderRadius: 3, overflow: 'hidden' },
  progressFill: { height: '100%', borderRadius: 3 },
  aralinPct: { fontSize: 14, fontWeight: '800', marginLeft: 16, width: 45, textAlign: 'right', fontFamily: 'Andika-Bold' },
});
